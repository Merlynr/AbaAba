...
class GridMapEnv:
    def __init__(self):
        ...
        self.punish = [1.01, 1.01, -1, -1, -1, -1, 1]
        self.data = {}
        # 跨页flag
    ...
    def saveTrace(self):
        ...
        with open(r"./datasets/trace_2.csv", 'w', newline='') as f:
            writer = csv.writer(f)
    ...
    def showTrace(self):
        ...
        if not os.path.getsize("./datasets/trace_2.csv"):
            return
        trace = pd.read_csv("./datasets/trace_2.csv")
    ...
    def reset(self):
        # 清空轨迹
        self.transit = self.born
        file_path = './datasets/trace_2.csv'
        self.trace = []
        self.data = {}
        # 跨页flag
        self.isToPageThenStep = 0
